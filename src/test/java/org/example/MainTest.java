...
class MainTest {
    ...
    void testMatchDrivers() {
        rideService.addDriver("D1", "John", 10.0, 20.0);
        rideService.addDriver("D2", "Mike", 11.0, 21.0);
        rideService.addRider("R1", "Alice", 10.5, 20.5);
    ...
    void testStopRide() {
        ...
        rideService.stopRide("Ride1", 15.0, 25.0, 30); // Stop the ride after traveling and time spent
    ...
    void testGenerateBillForCompletedRide() {
        ...
        rideService.stopRide("Ride1", 15.0, 25.0, 30);
    ...
    void testDistanceBasedDriverMatching() {
        ...
        rideService.addDriver("D1", "John", 10.0, 20.0); // Within range (close)
        rideService.addDriver("D2", "Mike", 11.0, 21.0); // Within range (slightly farther)
        rideService.addDriver("D3", "Sarah", 50.0, 50.0); // Out of range (>5km)
